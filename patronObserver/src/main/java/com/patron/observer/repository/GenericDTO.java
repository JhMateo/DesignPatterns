package com.patron.observer.repository;
...
public class GenericDTO<T> {
    ...
    public void deleteAll() {
        try {
            ...
            int rowsAffected = dbManager.executeUpdate(deleteSQL);
            ...
            if (rowsAffected > 0) {
                ...
                dbManager.rollbackTransaction();
                System.out.println("La eliminación de " + clazz.getSimpleName() + " falló.");
            }
        } catch (SQLException e) {
            e.printStackTrace();
            try {
